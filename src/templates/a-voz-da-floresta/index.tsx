    ...
    <motion.div key={6} {...animations.wrapper}>
      <S.Wrapper>
          ...
          items={[
            {
              ...
              desc: (
                <span>
                  ...
                  registrar, compartilhar e ampliar milhares de anos de cultura
                  e sabedoria altamente sustentável, integrativa, coletiva e
                  pacífica com o mundo digital binário.
                </span>
              ),
              links: (
                <>
        ...
        <ProgressiveCount
          ...
          desc={
            <span>
              ...
              originária a partir de registros independentes em colaboração com
              os próprios povos originários.
            </span>
          }
        ...
        <ArticlePreview
          ...
          body={
            <span>
              <p>
                ...
                vivemos em uma nova era onde a sociedade está plenamente ciente
                da necessidade de preservação da vida e do meio ambiente.
              </p>
              ...
              <p>
                ...
                séculos de perseguição, exploração e conflitos, estamos ganhando
                voz ativa na sociedade e acreditamos que é chegado o momento de
                abrir-nos para interagir com o mundo todo.
              </p>
              ...
              <p>
                {' '}
                Estamos gritando por atenção há mais de 500 anos. Nossa premissa
                é engajar cada vez mais pessoas na conservação da biodiversidade
                e desta cultura ancestral que tanto pode ajudar o planeta com
                nossos conhecimentos milenares sobre viver em harmonia com a
                floresta.
              </p>
              ...
              <p>
                ...
                deve ser REJEITADO em sua totalidade pela Casa Legislativa deste
                país, bem como os demais projetos que tramitam com o mesmo tema
                e propósito.
              </p>
          ...
          boxtitle={<span>Assinam essa carta [em contagem progressiva]:</span>}
          boxdesc={
            <span>
              Pajé Txaná Ixã, Pajé Txaná Kixtin, Ibã Huni kuin, Eduardo Pizaroli
              [Tete Beru], Shane Inu Bake [Guilherme Meneghelli], Camila Saibro,
              Mathilde Everaere, Flora Dutra, Advan Haschi, Rael Castro, Hugo
              Takemoto, Daniel Heberle, Graziele Borges, Gabriela Guidetti,
              Chloe Malkine, Nathalie Malkine [Pranad Monja do Amor], Vhera
              Xunú, Cacique Nasso, Cacique Geral da Nação Huni Kui Ninawa Inu
              Huni KuĪ...
            </span>
          }
        />
          ...
          body={
            <span>
              ...
              <p>
                ...
                &quot;Audiovisual Consciência Ambiental&quot; liderado por Isaka
                Huni Kuin, que já se lançou no mercado audiovisual
        ...
        <VideoBlockHor
          ...
          desc={
            <span>
              <p>
                {' '}
                Durante a World Unity Week, uma semana inteira com encontros de
                lideranças mundiais engajadas com a integração da ciência,
                cultura, espiritualidade e tecnologia, que aconteceu online nos
                dias 19 a 26 de junho de 2021, o discurso de encerramento, feito
                por Phil Lane Jr., enfatizou que precisamos ultrapassar as
                fronteiras territoriais e culturais e nos unirmos enquanto
                comunidade global, para que a paz no mundo seja finalmente
                alcançada.
              </p>
              <p>
                Em seu emocionado discurso no evento de encerramento da semana,
                após um dia dedicado a pauta indigenista, organizado pela nossa
                dedicada equipe Amazônia a.Live, ele se emociona ao agradecer
                aos engajados com a causa indígena, afirmando que se fizesse sua
                passagem agora, iria tranquilo e com a certeza que o mundo
                estará em boas mãos.
              </p>
            </span>
          }
        ...
        <ImageText
          ...
          desc={
            <span>
              ...
              conhecimento por tradição oral. Enquanto muitas dessas sabedorias
              estão a ponto de se perder, a FlorestaTV foi convidada em ajudar
              na estruturação de bibliotecas vivas de conhecimento dos povos da
              Floresta para o mundo digital binário.
            </span>
          }
