        ...
        <S.Content>
          <S.HeroWrapper>
            <div className="ico">
              ...
              />
              <h2>
                Tão amigável quanto é poderoso para unificar seus investimentos.
              </h2>
            </div>
          ...
          <S.Body>
            ...
            <p style={{ maxWidth: '720px' }}>
              ...
              aumentando a previsibilidade e impulsionando retornos financeiros.
            </p>
            <h3>Alta disponibilidade</h3>
            <p style={{ maxWidth: '720px' }}>
              Aproveite a liberdade, nossa aplicação está hospedada dentro de um
              dos maiores provedores de serviço em nuvem do mundo e pode ser
              acessada de qualquer lugar.
            </p>
            <h3>Consolidação</h3>
            <p style={{ maxWidth: '720px' }}>
              Visão consolidada dos portfólios, com cálculos de impostos e todos
              os ajustes necessários para apresentar a história financeira do
              seu cliente.
            </p>
