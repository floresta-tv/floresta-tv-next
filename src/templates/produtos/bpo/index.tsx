            ...
            <S.Body>
              <motion.div key={2} {...animations.wrapper}>
                ...
                <p style={{ maxWidth: '420px' }}>
                  ...
                  operação de back office e de customer experience, sempre com
                  muita qualidade e agilidade.
                </p>
                <h3>Custo acessível</h3>
                <p style={{ maxWidth: '450px' }}>
                  Com a Meuportfolio você pode ter um time de back office
                  disponível por um custo mais acessível se comparado com manter
                  seu próprio time dentro da sua empresa.
                </p>
                <h3>Segurança &amp; Sigilo</h3>
                <p style={{ maxWidth: '450px' }}>
                  Segurança &amp; Sigilo Estamos sempre preocupados em manter o
                  sigilo das informações que nosso time tem acesso. Garantimos
                ...
                <div className="mockup-caption">
                  <p>
                    ...
                    inovadora e excelência operacional, nosso BPO funciona como
                    o combustível do foguete que ajuda a alimentar a nave dos
                    nossos clientes.
                  </p>
                </div>
